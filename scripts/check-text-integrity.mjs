...
// We intentionally check only user-facing and routing-critical files.
const CHECK_TARGETS = [
  "middleware.ts",
  "src/app/layout.tsx",
  ...
  "src/app/error.tsx",
  "src/app/error-safe.tsx",
  "src/app/admin/error.tsx",
  "src/app/admin/error-safe.tsx",
  "src/app/admin/loading.tsx",
  "src/app/admin/loading-safe.tsx",
  "src/app/admin/inquiries/loading.tsx",
  "src/app/admin/inquiries/loading-safe.tsx",
  "src/app/admin/inquiries/[id]/loading.tsx",
  "src/app/admin/inquiries/[id]/loading-safe.tsx",
  "src/app/intake/page.tsx",
  "src/app/intake/page-safe.tsx",
  "src/app/intake/error.tsx",
  "src/app/intake/error-safe.tsx",
  "src/app/intake/loading.tsx",
  "src/app/intake/loading-safe.tsx",
...
const checks = [
  ...
  },
  {
    ...
    reason: "suspicious '? + Hangul' sequence detected"
  },
  {
