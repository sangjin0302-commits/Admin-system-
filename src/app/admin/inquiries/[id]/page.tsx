        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <div className="mt-4 grid gap-2 text-sm text-text-muted sm:grid-cols-2 xl:grid-cols-3">
              ...
              <p>업데이트일: {formatDateTime(inquiry.updatedAt)}</p>
              <p>의뢰인: {inquiry.contactName}</p>
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div className="mt-5 grid gap-3">
              ...
              <InfoItem label="상담 필요 여부" value={inquiry.consultationRequired ? "필요" : "기본안내 후 진행"} />
            ...
            <Card muted className="mt-5 p-5">
              ...
              <p className="mt-3 text-sm text-text">{inquiry.riskComplexityHint || "일반 난이도"}</p>
            </Card>
            <Card muted className="mt-5 p-5">
          ...
          <Card className="p-6">
            ...
            <p className="mt-2 text-sm text-text-muted">
              추후 이메일, 문자, 알림톡 연결 시 사용할 템플릿 구조입니다.
            </p>
            <div className="mt-5">
          ...
          <Card className="p-6">
            <h3 className="ui-section-title">현재 저장된 자동 생성 텍스트</h3>
