    ...
    <div className="overflow-x-clip">
      ...
      <section className="relative overflow-hidden pt-20 pb-16 sm:pt-28 sm:pb-20">
        ...
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
          ...
          <Reveal delay={1}>
            <h1 className="ethos-display mt-5 text-4xl sm:text-[3.6rem]">업무 분야</h1>
          </Reveal>
          <Reveal delay={2}>
            ...
            {AREAS.map((a, i) => (
              <Reveal key={a.href} delay={((i % 2) + 1) as 1 | 2}>
                ...
                >
                  ...
                  <h3 className="ethos-display relative mt-1 text-2xl">{a.title}</h3>
                  <p className="relative mt-5 text-sm leading-7 text-text">{a.description}</p>
