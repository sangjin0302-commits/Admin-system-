...
export const inquiryTypeDocuments: Record<InquiryType, Record<Locale, string[]>> = {
  ...
  APOSTILLE_CONSULAR: {
    ...
    ar: ["[Arabic placeholder] Original document list", "[Arabic placeholder] Issuing country", "[Arabic placeholder] Target authority", "[Arabic placeholder] Notarization status"]
  },
  TRANSLATION_NOTARY: {
    ...
    ar: ["[Arabic placeholder] Source file", "[Arabic placeholder] Translation direction", "[Arabic placeholder] Notarization requirement", "[Arabic placeholder] Page count"]
  },
  GENERAL_ADMIN_CIVIL: {
    ...
    ar: ["[Arabic placeholder] Target authority information", "[Arabic placeholder] Purpose of the request", "[Arabic placeholder] Rejection history", "[Arabic placeholder] Related permit documents"]
  },
  CORPORATE_REQUEST: {
...
export const inquiryTypeCautions: Record<InquiryType, Record<Locale, string>> = {
  ...
  APOSTILLE_CONSULAR: {
    ...
    ar: "[Arabic placeholder] Consular legalization may be required instead of apostille."
  },
  TRANSLATION_NOTARY: {
    ...
    ar: "[Arabic placeholder] Translation format may vary by destination authority."
  },
  GENERAL_ADMIN_CIVIL: {
    ko: "기관별 요구 양식이 다를 수 있으므로 제출처 확인이 중요합니다.",
    en: "Required forms may differ by agency, so the target authority should be confirmed.",
    ar: "[Arabic placeholder] Required forms may differ by agency."
  },
  CORPORATE_REQUEST: {
