...
export const FEATURE_REGISTRY: readonly FeatureDefinition[] = [
  ...
  { key: "nav_about", label: "메뉴: 소개", category: "marketing", default: true, description: "상단 메뉴 '소개' 노출", public: true },
  { key: "nav_services", label: "메뉴: 분야", category: "marketing", default: true, description: "상단 메뉴 '분야' 노출", public: true },
  { key: "nav_consult", label: "메뉴: 상담", category: "marketing", default: true, description: "상단 메뉴 '상담' 노출", public: true },
  { key: "nav_quick_check", label: "메뉴: AI 진단", category: "marketing", default: true, description: "상단 메뉴 'AI 진단' 노출", public: true },
  { key: "nav_ai_screen", label: "메뉴: 빠른 진단", category: "marketing", default: true, description: "상단 메뉴 '빠른 진단' 노출", public: true },
  { key: "nav_cases", label: "메뉴: 활동", category: "marketing", default: true, description: "상단 메뉴 '활동' 노출", public: true },
  { key: "nav_blog", label: "메뉴: 칼럼", category: "marketing", default: true, description: "상단 메뉴 '칼럼' 노출", public: true },
