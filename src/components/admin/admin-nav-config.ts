...
export type NavGroup = {
  title: string;
  items: NavItem[];
  /** 첫 방문 시 접힌 상태로 렌더한다(실험·고급 기능용). localStorage에 저장값이 있으면 그쪽이 우선. */
...
/**
 * 운영자 메뉴 — 가치사슬(유입→상담→수행→정산→유지) + 빈도 기준 재편.
 *
 * 설계 근거:
 *  - Porter 가치사슬: 사무소가 돈 버는 순서를 상위 그룹의 뼈대로.
 *  - Miller 7±2: 그룹당 항목을 5~8개로 제한(예전 '분석' 22개·'설정' 30개는 목록이지 메뉴가 아니었다).
 *  - 파레토/빈도 우선: 매일 쓰는 그룹이 위, 가끔 쓰는 그룹이 아래.
 *  - 점진적 노출: 실험·고급 기능은 지우지 않되 '실험실'로 내리고 기본 접힘.
 *
 * 페이지·코드는 그대로 있다. 여기서 바뀌는 건 "무엇을 먼저 보여줄지"뿐이다.
 */
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/services", label: "서비스 편집", icon: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" },
      { href: "/admin/content-metrics", label: "콘텐츠 성과", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
      ...
      { href: "/admin/help/blog-categories", label: "블로그 카테고리 도움말", icon: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/market", label: "시장·경쟁사 분석", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/integrations/google-services", label: "Google Drive·Docs·Meet", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
      { href: "/admin/integrations/doc-templates", label: "문서 서식", icon: "M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" },
