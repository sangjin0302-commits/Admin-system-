...
const steps: WorkflowStep[] = [
  {
    key: "RECEIVED",
    title: "접수",
    description: "문의 기본 정보와 요청 결과를 수집하는 단계"
  },
  {
    key: "ANALYZED",
    title: "분석",
    description: "AI/Lawbot 분석과 추가 확인 사항을 정리하는 단계"
  },
  {
    key: "QUOTING",
    title: "견적",
  ...
  },
  {
    key: "CONTRACT",
    title: "계약/수임",
    description: "계약 초안, 특약, 수임 전환을 마무리하는 단계"
  },
  {
    key: "CASEWORK",
    title: "사건 진행",
    description: "서류 수집, 제출, 보완 작업을 진행하는 단계"
  },
  {
    key: "CLOSED",
    title: "종결",
    description: "사건 완료 또는 종결 정리를 마치는 단계"
  }
];
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-text-muted">
            현재 단계는 <span className="font-semibold text-text-strong">{currentStep.title}</span>이며, 다음 작업으로 자연스럽게 이어지도록 흐름을 제시합니다.
          </p>
        </div>
