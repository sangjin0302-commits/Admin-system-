...
const NAV_GROUPS: NavGroup[] = [
  {
    title: "브리핑",
    items: [
      { href: "/admin/morning", label: "아침 3분 브리핑", icon: "M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" },
      ...
      { href: "/admin/blog-rewrite-queue", label: "블로그 리라이트 큐", icon: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" },
