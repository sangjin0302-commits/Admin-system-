...
import { BooleanBadge, toStatusBadgeTone } from "./shared";

export function StatusCard({ model }: { model: LawbotReviewReadonlyUiModel }) {
  return (
...
export function ApprovalGateCard({ model }: { model: LawbotReviewReadonlyUiModel }) {
  return (
    <Card muted className="p-5">
...
export function ReviewSignalsCard({ model }: { model: LawbotReviewReadonlyUiModel }) {
  return (
    <Card muted className="p-5">
...
export function ReviewQueueCard({ model }: { model: LawbotReviewReadonlyUiModel }) {
  return (
    <Card muted className="p-5">
