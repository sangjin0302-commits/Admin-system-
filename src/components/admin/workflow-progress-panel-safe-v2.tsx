...
export function WorkflowProgressPanelSafeV2({
  currentKey,
  lawbotStatus,
  quoteStatus,
  caseStage
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-text-muted">
            현재 단계는 <span className="font-semibold text-text-strong">{currentStep.title}</span>이며, 다음 작업으로
            자연스럽게 이어지도록 흐름을 표시합니다.
          </p>
        </div>
